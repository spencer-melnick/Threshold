	...
	AController* EventInstigator, AActor* DamageCauser)
{
	...
	UE_LOG(LogThresholdGame, Display, TEXT("%s took %.2f damage from %s"), *GetNameSafe(this),
...
void ATHCharacter::PerformNextAttack(EWeaponMoveType MoveType)
{
	...
	{
		UE_LOG(LogThresholdGame, Warning, TEXT("Attempting to access out of range move %d in %s"),
